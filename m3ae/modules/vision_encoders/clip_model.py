...
class VisualTransformer(nn.Module):
    ...
    def forward_multihead_attention(self, x, b, with_aff=False, attn_mask=None):
        """ 
    ...
    def forward(self, x: torch.Tensor, x_mask):
        ...
        extract_layers = [0, 3, 7, 9]
        activations, affinities = [], []
        for i, res_block in enumerate(self.transformer.resblocks):
            
            x, aff_per_head = self.forward_multihead_attention(x, res_block, with_aff=True, attn_mask=x_mask)

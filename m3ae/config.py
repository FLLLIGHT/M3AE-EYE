...
def config():
    ...
    octa_image_size = {"height": 400, "width": 400, "channel": 3}
...
# 分割下游任务
@ex.named_config
def task_finetune_seg_octa500():
    exp_name = "task_finetune_seg_octa500"
    datasets = ["seg_octa500"]
    loss_names = _loss_names({"seg": 1})
    batch_size = 16
    max_epoch = 20
    max_steps = None
    warmup_steps = 0.1
    ...
    label_column_name = "task_finetune_seg_octa500"
